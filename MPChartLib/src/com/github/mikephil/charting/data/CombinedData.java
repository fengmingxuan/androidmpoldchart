...
//                Log.d("xindex------", "entry="+((Entry) entry).getXIndex()+"---high="+highlight.getXIndex());
//                Log.d("getVal------", "entry="+((Entry) entry).getVal()+"---high="+highlight.getValue());
                if (((Entry) entry).getXIndex() == highlight.getXIndex() ||
